...
async function listMembers(spinner, format = 'top') {
    ...
    spinner.stop();
    fs.writeFileSync(path.join(I18N_OUTPUT_DIR, 'topMembers.json'), JSON.stringify(data[format]));
